...
export function CTA(props: CTAProps) {
  ...
  return (
    <section className='border-border/70 relative z-10 overflow-hidden border-b bg-white/45 px-6 py-24 md:py-32'>
      <AnimateInView
      ...
      >
        ...
        <div className='mt-8 flex items-center justify-center gap-3'>
          ...
          >
            {t('Get Started')}
            <ArrowRight className='ml-1 size-3.5 transition-transform duration-300 group-hover:translate-x-0.5' />
          </Button>
          <Button
            variant='outline'
