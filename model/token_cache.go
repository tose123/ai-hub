...
redis.call('HSET', KEYS[1],
  ...
  'ModelMapping', ARGV[11], 'AllowIps', ARGV[12], 'Group', ARGV[13],
  'CrossGroupRetry', ARGV[14], 'AutoGroups', ARGV[15],
...
return 1`
	...
	return common.RDB.Eval(context.Background(), script, []string{
		...
		token.ModelLimits, token.ModelMapping, allowIps, token.Group, strconv.FormatBool(token.CrossGroupRetry),
